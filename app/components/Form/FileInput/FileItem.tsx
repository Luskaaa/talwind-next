...
import { CheckCircle2Icon, Trash2, UploadCloud } from "lucide-react";
    ...
    <div className={container()}>
      ...
      {state === "error" ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <button
            type="button"
            className="font-sm text-error-700 hover:text-error-700 dark:text-error-400 dark:hover:text-error-300 font-semibold"
          >
            Try again
          </button>
        </div>
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="w-name-file flex flex-col lg:w-full">
