  ...
  return (
    <strong className="flex mx-1 items-center gap-2 text-xl font-semibold text-zinc-900">
      <svg
        ...
        viewBox="0 0 38 38"
      >
        <g filter="url(#filter0_dd_28087_307)">
          <g clipPath="url(#clip0_28087_307)">
            ...
            <rect
              ...
              x="3"
              y="2"
              fill="url(#paint0_linear_28087_307)"
              rx="8"
            ></rect>
            <path
              fill="#D0D5DD"
            ...
            <path
              ...
              clipRule="evenodd"
            ></path>
            <path fill="#D0D5DD" d="M18.961 2h.078v32h-.078z"></path>
            <path fill="#D0D5DD" d="M35 17.96v.079H3v-.078z"></path>
            <path
              fill="#D0D5DD"
              d="M29.602 2h.078v32h-.078zM13.64 2h.078v32h-.077zM24.282 2h.077v32h-.077zM8.32 2h.078v32H8.32z"
            ></path>
            <path
              fill="#D0D5DD"
              d="M35 28.602v.077H3v-.077zM35 12.64v.078H3v-.077zM35 23.281v.078H3v-.078zM35 7.32v.078H3V7.32z"
            ></path>
            <g filter="url(#filter1_dd_28087_307)">
              <circle
                cx="19"
                cy="18"
                r="8"
                fill="url(#paint1_linear_28087_307)"
              ></circle>
            </g>
            <path
              fill="#fff"
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result="effect1_dropShadow_28087_307"
            ></feBlend>
            <feColorMatrix
              in="SourceAlpha"
              result="hardAlpha"
            ...
            <feBlend
              in2="effect1_dropShadow_28087_307"
              result="effect2_dropShadow_28087_307"
            ></feBlend>
            <feBlend
              in="SourceGraphic"
              in2="effect2_dropShadow_28087_307"
              result="shape"
            ></feBlend>
          </filter>
          <filter
            id="filter1_dd_28087_307"
            width="22"
            height="22"
            x="8"
            y="8"
